...
for i in range(len(images)):
    ...
    if first_character is not None:
        captcha_filename = '%s/images/captchas/%d.png' % (project_root, i)
        image.save(captcha_filename)
        first_filename = '%s/images/characters/%d_%d.png' % (project_root, i, 0)
        second_filename = '%s/images/characters/%d_%d.png' % (project_root, i, 1)
        third_filename = '%s/images/characters/%d_%d.png' % (project_root, i, 2)
        fourth_filename = '%s/images/characters/%d_%d.png' % (project_root, i, 3)
