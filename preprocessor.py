...
def get_character_contours_info(contours):
    contours_info = [get_rect_info(contour) for contour in contours]
    contours_info = [contour_info for contour_info in contours_info if contour_info['area'] > 22]
...
def get_digits(image):
    ...
    character_contours_info = get_character_contours_info(contours)
